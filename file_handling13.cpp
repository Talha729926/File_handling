...
int main() {
  std::string inputFile = "ali.txt"; // Input file (encrypted)
  displayFileContent("ali.txt"); // Display content of "encrypted_test.txt"
  std::cout << std::endl; // Output a newline for formatting

  std::string outputFile = "ali.txt"; // Output file (decrypted)
  decryptFile(inputFile, outputFile); // Decrypt "encrypted_test.txt" and write to "decrypted_test.txt"
  displayFileContent("ali.txt"); // Display content of "decrypted_test.txt"
  std::cout << std::endl; // Output a newline for formatting
