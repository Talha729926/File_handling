...
int main() {
  std::string inputFile = "ali.txt"; // Input file
  displayFileContent("ali.txt"); // Display content of "test.txt"
  std::cout << std::endl; // Output a newline for formatting

  std::string outputFile = "ali.txt"; // Output file for encrypted content
